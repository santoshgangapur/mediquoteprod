...
import { ViewMode, PatientProfile, FamilyMember } from '../types';
          ...
          <div className="relative" ref={profileDropdownRef}>
            ...
            >
              <div className="flex flex-col text-right leading-tight min-w-0">
                ...
                <span className="text-[10px] font-mono-data text-[#64748b] font-semibold">
                  {authUser.mobileNumber}
                </span>
              </div>

              <div className="w-8 h-8 rounded-full bg-[#003178] text-white flex items-center justify-center text-[13px] font-bold shadow-2xs shrink-0">
            ...
            {isProfileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-[#c3c6d4] p-3 z-50 animate-in fade-in zoom-in-95 duration-150 space-y-2">
                {/* User Info Header */}
                <div className="p-3 bg-[#f3faff] rounded-xl border border-[#c3c6d4]/60">
                  <div className="flex items-center gap-2.5">
                    <div className="w-10 h-10 rounded-full bg-[#003178] text-white flex items-center justify-center font-bold text-[16px] shadow-xs shrink-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[11px] font-mono-data text-[#003178] font-bold">
                        {authUser.mobileNumber}
                      </p>
                    </div>
                  </div>
                  <div className="mt-2 flex items-center justify-between border-t border-[#cbd5e1] pt-2 text-[10px]">
                    <span className="text-[#64748b] font-medium">Role Account:</span>
                ...
                {/* Logout Action in Profile Dropdown */}
                {onLogout && (
